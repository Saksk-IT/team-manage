...
- Codex API 登录教程页：`/codex-guide` 提供独立教程页面与静态素材，并提供 Claude Code / Open Code / Open Claw 独立配置教程。
...
| `GET /claude-code-guide` | Claude Code 配置教程 |
| `GET /open-code-guide` | Open Code 配置教程 |
| `GET /open-claw-guide` | Open Claw 配置教程 |
| `GET /health` | 健康检查 |
