...
""")
    ...
    async def test_local_record_workbench_static_assets_use_clickable_values(self):
        ...
        self.assertIn("record-card__field--copyable", script)
        self.assertIn("record-card__title--copyable", script)
        self.assertIn("bindCopyableRecordElement", script)
        self.assertIn("element.addEventListener('click'", script)
        self.assertIn("element.addEventListener('keydown'", script)
        self.assertIn("record-card__copy-value", script)
        self.assertIn("role', 'button'", script)
        self.assertNotIn("createCopyValueButton", script)
        ...
        self.assertIn("fetchInboxForRecordEmailAccount", script)
        self.assertIn("refreshAndCopyEmailAccountResult", script)
